...
{% elsif site.data.article_settings.show_dates == true and article.data.article_settings.show_date == false %}
  {% assign toggle_article_date = "hide-article-date" %}
{% elsif site.data.article_settings.show_comments == blank and article.data.article_settings.show_comments == blank %}
  {% assign toggle_article_date = "show-article-comment" %}
{% else %}
