<header class="site-header is-loading js-site-header">
  ...
  <div class="header-menu js-header-menu" data-initial-width="unset">
    ...
    {% if show_language_menu_popover %}
      <button class="menu-language-btn ico-flags ico-flag-{{ page.language_code }} js-toggle-menu-language js-menu-language-popover-btn js-prevent-sideclick" data-lang-code="{{ page.language_locale }}" {{ edy_intro_add_lang }}>
